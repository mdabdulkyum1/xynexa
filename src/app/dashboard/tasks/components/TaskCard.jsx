...
const TaskCard = () => {
    return (
        <div className='bg-white dark:bg-[#0A0A0A] p-4 rounded-lg shadow-md'>
            <div className='flex justify-between items-center'>
                <h3 className='font-medium dark:font-normal text-gray-900 dark:text-gray-100'>Create Calender Design</h3>
            ...
            <div className='flex gap-2 font-semibold text-xs py-2'>
                ...
                <div className="flex items-center justify-between md:gap-4 gap-2">
                    <AvatarGroup max={4}>
                        <Avatar
                            ...
                            alt="Remy Sharp"
                            src="https://i.ibb.co/B6sBj8C/stokes.jpg"
                        />
                        <Avatar
                            sx={{ width: 24, height: 24 }}
                            alt="Travis Howard"
                            src="https://i.ibb.co/103M16B/man-outside-091318-800x450.jpg"
                        />
                        <Avatar
                            sx={{ width: 24, height: 24 }}
                            alt="Cindy Baker"
                            src="https://i.ibb.co/DMRpJqg/IMG-20220410-223356.jpg"
                        />
                        <Avatar
                            sx={{ width: 24, height: 24 }}
                            alt="Cindy Baker"
