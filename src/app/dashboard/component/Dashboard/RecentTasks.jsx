...
const RecentTasks = () => {
    ...
    const lastFourTasks = allTasks?.slice(-4);

    return (
        <div className="mt-3 flex flex-col p-4 rounded-xl shadow-md bg-white w-full dark:bg-gray-800">
            <h2 className="text-xl font-semibold mb-4 dark:text-white w-full">Recent Tasks</h2>
            {allTasks?.length === 0 && (
                
    <p className="flex justify-center items-center h-36 text-gray-500">No recent tasks found.</p>
)}
