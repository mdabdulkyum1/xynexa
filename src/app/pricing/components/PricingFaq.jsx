...
const PricingFaq = () => {
    return (
        <div className='w-11/12 mx-auto my-10 lg:my-28'>
            ...
            <p>Find answers to your questions right here, and don't hesitate to
                <span className='text-primary font-bold'><Link href="/contact-us"> contact us </Link></span>
                 if you couldn't find what you're looking for.</p>
            </div>
            {/* faq */}
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-gray-600 dark:text-gray-800'>
  <div className='border-2 p-6 rounded-xl lg:col-span-2 bg-[#EAEEF1]'>
  ...
  <div className='border-2 p-6 rounded-xl lg:row-span-2 flex flex-col justify-center bg-[#EAEEF1]'>
  ...
  <div className='border-2 p-6 rounded-xl bg-[#EAEEF1]'>
  ...
  <div className='border-2 p-6 rounded-xl lg:row-span-3 flex flex-col justify-center bg-[#EAEEF1]'>
