...
const AboutHelp = () => {
    return (
        <div className='bg-[#f6d9f2f6] dark:bg-transparent my-10 lg:my-20 p-6 lg:p-16 text-center'>
            <h2 className='font-bold text-2xl lg:text-5xl mb-4 lg:mb-8'>How XYnexa helps</h2>
            <p className='text-gray-500 dark:text-gray-300 lg:w-1/2 mx-auto text-xs lg:text-[16px]'>Xynexa is an advanced team collaboration and task management platform built to enhance productivity and streamline workflows. Whether you’re managing a small team or handling large projects, Xynexa offers real-time updates, intuitive task tracking, and seamless communication to keep everyone aligned.
                ...
                <div className='flex flex-wrap gap-6 my-8 justify-center items-end'>
                    <div className='p-4'>
                        ...
                        <p className='text-gray-500 dark:text-gray-300'>Lexend founded.</p>
                    </div>
                    <div className='p-4'>
                        <h2 className='font-bold text-2xl lg:text-4xl'>50</h2>
                        <p className='text-gray-500 dark:text-gray-300'>Hardworking group.</p>
                    </div>
                    <div className='p-4'>
                        <h2 className='font-bold text-2xl lg:text-4xl'>100K</h2>
                        <p className='text-gray-500 dark:text-gray-300'>Document workflows.</p>
                    </div>
