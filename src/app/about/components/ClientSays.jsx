    ...
    return (
        <div className="max-w-6xl mx-auto px-2 md:px-4 py-8">
            <div className="mt-8 text-center">
                <h2 className="text-2xl md:text-3xl lg:text-5xl font-bold py-4 md:py-8 text-gray-800">
            ...
            <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                ...
                <div className="bg-white rounded-lg shadow-md xl:py-8 md:p-6 w-full md:w-1/3 border p-4">
                    <div className="flex items-center mb-4 text-2xl">
                        <LucideCodesandbox className="mr-2" size={32} />

                        <span className="font-bold">Boltshift</span>
                    </div>
                    ...
                    <div className="mt-6 flex items-center">
                        ...
                        <div>
                            <span className="font-bold">Mark Zellers</span><br />
                ...
                <div className="bg-white rounded-lg shadow-md xl:py-8 md:p-6 w-full md:w-1/3 border p-4">
                    <div className="flex items-center mb-4 text-2xl">
                        ...
                        <span className="font-bold">Lightbox</span>
                    </div>
                    <p className="text-gray-600 text-xl">
                ...
                <div className="bg-white rounded-lg shadow-md xl:py-8 md:p-6 w-full md:w-1/3 border p-4">
                    <div className="flex items-center mb-4 text-2xl">
                        <SquareLibraryIcon className="mr-2 text-3xl" size={32} />
                        <span className="font-bold">Interlock</span>
                    </div>
                    <p className="text-gray-600 text-xl">
                    ...
                    <div className="mt-6 flex items-center">
                        ...
                        <div>
                            <span className="font-bold">Sarah Edrissi</span><br />
            ...
            <div className="mt-8 text-center">
                <a href="#" className="text-purple-600 hover:text-purple-700 font-semibold">See all feedbacks →</a>
            </div>
        </div>
    );
};
