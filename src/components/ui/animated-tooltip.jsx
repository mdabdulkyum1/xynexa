...
export const AnimatedTooltip = ({
  ...
  return (
    <>
      {items?.map((item, idx) => (
        <div
          className="group relative z-10 -mr-4"
          key={item?._id}
          ...
          <AnimatePresence mode="popLayout">
            {hoveredIndex === item?._id && (
              <motion.div
                ...
                className="absolute top-12 left-1/2 z-50 flex -translate-x-1/2 flex-col items-center justify-center rounded-md bg-white px-4 py-2 text-xs shadow-xl">
                <div
